...
namespace CsvLogger.Exceptions
{
    public class IncorrectFileTypeException : Exception
    {
        ...
        public static void ThrowIfIncorrectFileType(FileInfo file, string expectedFileType)
        {
            ...
            if (!file.Extension.Contains(expectedFileType)) throw new IncorrectFileTypeException($"The file type of {file.FullName} does not matcht the expected file type of {expectedFileType}");
        }
    }
}